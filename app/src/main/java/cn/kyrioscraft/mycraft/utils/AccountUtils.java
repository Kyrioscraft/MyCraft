...
package cn.kyrioscraft.mycraft.utils;
...
import static cn.kyrioscraft.mycraft.utils.LogUtils.LOGV;
...
public class AccountUtils {
    ...
    public static Account addAccount(Account account, String password, Bundle userdata){
...
//        tryAuthenticateWithErrorNotification(mContext, ScheduleContract.CONTENT_AUTHORITY);
        tryAuthenticateWithErrorNotification(mContext, "cn.kyrioscraft.mycraft");
    }
